(()=>{
'use strict';
const VERSION=window.ARCANE_BUILD||'dev';
...
if(!document.querySelector('script[data-release-ui]')){const s=document.createElement('script');s.src='release-ui-v1.js?v=1';s.dataset.releaseUi='1';document.head.appendChild(s)}
})();