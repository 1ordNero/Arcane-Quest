...
function layout(){
 if(typeof S==='undefined'||S?.screen!=='char'||S.heroView!=='equipment')return;
 const root=document.querySelector('.he4');const panel=root?.querySelector('.he4-panel');if(!root||!panel||panel.querySelector('.he7-shell'))return;
 ...
 const core=root.querySelector('.he4-core');const stats=root.querySelector('.he4-stats');
