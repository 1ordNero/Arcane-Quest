...
.tabs button{flex:1;min-width:0!important;height:52px;padding:5px 1px!important;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;overflow:visible}
.tabs button span{font-size:19px;line-height:20px}.tabs button small{font-size:8px;white-space:nowrap}
.tabs .hero-tab{position:relative;transform:translateY(-14px);height:70px;max-width:72px;border-radius:50%!important;background:linear-gradient(145deg,#8f62df,#5f399f)!important;border:3px solid #2a2038;box-shadow:0 7px 20px #0009,0 0 0 2px #f4c15d33!important;color:white!important}
...
@media(max-width:370px){.tabs button small{font-size:7px}.tabs button span{font-size:17px}.tabs .hero-tab{max-width:62px}}
`;
