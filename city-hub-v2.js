...
.cv2{max-width:760px;margin:auto}.cv2-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.cv2-grid>button{position:relative;display:grid;grid-template-columns:48px 1fr;gap:10px;text-align:left;align-items:center;background:var(--panel);border:1px solid #ffffff10;box-shadow:none;padding:13px}.cv2-icon{width:48px;height:48px;display:flex;align-items:center;justify-content:center}.cv2-icon img{display:block;width:48px;height:48px;object-fit:contain}.cv2-grid b,.cv2-grid small,.cv2-grid em{display:block}.cv2-grid b{font-size:12px}.cv2-grid small{font-size:8px;line-height:1.4;color:var(--muted);margin-top:2px}.cv2-grid em{font-size:7px;font-style:normal;color:var(--gold);margin-top:5px}.cv2-lock{position:absolute!important;right:8px;top:8px;font-size:11px!important}.cv2-shrine{border-color:#a875ff3d!important;background:radial-gradient(circle at 0 50%,#8f62df16,transparent 42%),var(--panel)!important}.cv2-back{margin:0 0 8px;background:#ffffff08;border:1px solid #ffffff10;box-shadow:none;padding:7px 10px;font-size:9px}
@media(max-width:620px){.cv2-grid{grid-template-columns:1fr}.cv2-grid>button{grid-template-columns:58px 1fr;min-height:104px;padding:13px 15px}.cv2-icon,.cv2-icon img{width:56px;height:56px}.cv2-grid b{font-size:15px}.cv2-grid small{font-size:10px}.cv2-grid em{font-size:9px}}
