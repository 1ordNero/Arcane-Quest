...
.cv2{max-width:760px;margin:auto}.cv2-head{background:linear-gradient(135deg,#2b1b40,#17111f);border:1px solid #ffffff14;border-radius:17px;padding:15px}.cv2-head h1{margin:3px 0;font-size:22px}.cv2-head p{margin:5px 0 0;font-size:9px;line-height:1.45;color:var(--muted)}.cv2-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:8px;margin-top:9px}.cv2-grid>button{position:relative;display:grid;grid-template-columns:42px 1fr;gap:9px;text-align:left;align-items:center;background:var(--panel);border:1px solid #ffffff10;box-shadow:none;padding:12px}.cv2-icon{width:42px;height:42px;display:flex;align-items:center;justify-content:center}.cv2-icon img{display:block;width:42px;height:42px;object-fit:contain}.cv2-grid b,.cv2-grid small,.cv2-grid em{display:block}.cv2-grid b{font-size:11px}.cv2-grid small{font-size:8px;line-height:1.4;color:var(--muted);margin-top:2px}.cv2-grid em{font-size:7px;font-style:normal;color:var(--gold);margin-top:5px}.cv2-lock{position:absolute!important;right:8px;top:8px;font-size:11px!important}.cv2-shrine{border-color:#a875ff3d!important;background:radial-gradient(circle at 0 50%,#8f62df16,transparent 42%),var(--panel)!important}.cv2-back{margin:0 0 8px;background:#ffffff08;border:1px solid #ffffff10;box-shadow:none;padding:7px 10px;font-size:9px}
@media(max-width:520px){.cv2-grid{grid-template-columns:1fr}.cv2-icon,.cv2-icon img{width:40px;height:40px}}
