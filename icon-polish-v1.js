(()=>{
function img(src,cls='ui-section-icon'){return `<img class="${cls}" src="${src}" alt="" aria-hidden="true" loading="lazy" decoding="async">`}
function polish(){
  ...
  if(['city','merchant','bank','forge','shrine'].includes(screen)){
...
window.Arcane?.on?.('afterRenderSettled',polish);
window.Arcane?.on?.('bootReady',polish);
