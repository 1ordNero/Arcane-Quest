...
const ASSETS={
 ...
 Druide:{shift:'skill_druid_shapeshift.webp',claw:'skill_druid_wild_claw.webp',bark:'skill_druid_barkskin.webp'}
};
...
/* Never allow a skill asset to inherit generic/global img sizing. */
...
/* The picker markup is appended inside #app. Make that modal itself the viewport overlay; do not rely on :has(). */
...
/* Add a dedicated class to the picker after every render, avoiding selector ambiguity in older WebViews. */
