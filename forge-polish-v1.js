(()=>{
'use strict';
function polish(){const root=document.querySelector('.fv4');if(!root)return;root.classList.add('aq-forge-polished');const tabs=root.querySelector('.fv4-tabs');if(tabs)tabs.setAttribute('aria-label','Schmiedebereiche')}
